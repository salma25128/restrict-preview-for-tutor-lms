...
class RPTL_Auth_UI {
	...
	public static function render_modal( RPTL_Access $access ) {
		...
		<div class="rptl-overlay" id="rptl-overlay" aria-hidden="true">
			<div class="rptl-modal" role="dialog" aria-modal="true" aria-labelledby="rptl-modal-title">
				<button type="button" class="rptl-close" id="rptl-close" aria-label="<?php esc_attr_e( 'Close', 'restrict-preview-for-tutor-lms' ); ?>">
	...
	public static function auth_tabs( $redirect_to = '' ) {
		...
		<div class="rptl-auth" data-rptl-auth>
			<?php if ( $can_register ) : ?>
				<div class="rptl-tabs" role="tablist" aria-label="<?php esc_attr_e( 'Log in or sign up', 'restrict-preview-for-tutor-lms' ); ?>">
					<button type="button" class="rptl-tab is-active" role="tab"
						...
						<?php esc_html_e( 'Log In', 'restrict-preview-for-tutor-lms' ); ?>
					</button>
					<button type="button" class="rptl-tab" role="tab"
						...
						<?php esc_html_e( 'Sign Up', 'restrict-preview-for-tutor-lms' ); ?>
					</button>
