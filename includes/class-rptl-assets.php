	...
	private function script_data() {
		...
		return array(
			...
			'i18n'        => array(
				...
				'unitBadgeOne' => __( '%d Free Lesson', 'restrict-preview-for-tutor-lms' ),
				/* translators: %d: number of free lessons. */
				'unitBadgeMany' => __( '%d Free Lessons', 'restrict-preview-for-tutor-lms' ),
				'phoneLabel'   => __( 'Phone Number', 'restrict-preview-for-tutor-lms' ),
				'mobileLabel'  => __( 'Mobile Number', 'restrict-preview-for-tutor-lms' ),
			),
		);
	}
}
